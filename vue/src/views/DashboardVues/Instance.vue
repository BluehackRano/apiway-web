<template>
          ...
          <ul class="list-group list-group-flush">
            ...
            <li>
                <button type="button" @click="" class="btn btn-info">
                <router-link :to="{ name: 'Instance Detail',  params: {user : 123, repo : 'asd'} }">Project Detail</router-link>
                </button>
               <!-- <p> <router-link :to="{ name: 'Instance Detail',  params: {user : 123, repo : 'asd'} }">Project Detail</router-link></p> -->
            </li>
          </ul>
        </div>
 </template>
